                    ...
                    child: SingleChildScrollView(
                      ...
                      child: ConstrainedBox(
                        constraints: const BoxConstraints(
                          maxWidth: kWebFormMaxWidth,
                        ),
                        child: _buildFormContent(theme, error),
                      ),
                    ),
                  ),
                ),
            ...
            slivers: [
              SliverFillRemaining(
                ...
                child: Padding(
                  ...
                  child: _buildFormContent(theme, error, expandFooter: true),
                ),
              ),
            ],
          ),
    ...
    return Column(
      children: [
        ...
        const Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            _FeatureChip(icon: Icons.folder_rounded, label: 'Organiza'),
            SizedBox(width: 10),
            _FeatureChip(icon: Icons.auto_awesome_rounded, label: 'Clasifica'),
            SizedBox(width: 10),
            _FeatureChip(icon: Icons.verified_user_outlined, label: 'Seguro'),
          ],
        ),
        const SizedBox(height: 28),
        LiquidGlassCard(
